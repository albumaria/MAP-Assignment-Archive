...
public class Repository implements IRepository {
    ...
    public Set<Integer> getPrgIdSet() {
        Set<Integer> prgIdSet = new HashSet<>();
        for (PrgState prg : this.prgList) {
            prgIdSet.add(prg.getPrgId());
        }
        return prgIdSet;
    }
    ...
    public void restartRepo(IStmt originalProgram) {
        ...
        PrgState initialPrg = new PrgState(exeStack, symTable, output, fileTable, heap, latchTable, originalPrgCopy);
    }
}
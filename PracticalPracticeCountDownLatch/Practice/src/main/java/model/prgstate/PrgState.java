...
public class PrgState {
    ...
    public PrgState(IADTStack<IStmt> stack, IADTDictionary<String, IValue> stable, IADTList<IValue> out, IFileTable ftable, IHeap heap, ILatchTable latchTable, IStmt prg) {

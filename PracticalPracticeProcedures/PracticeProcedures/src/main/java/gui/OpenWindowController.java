...
public class OpenWindowController {
    ...
    private void populateAllProgramsList() {
        ...
        IADTList<String> proc12 = new ADTList<>();
        proc12.add("a");
        proc12.add("b");
        IADTList<IExp> call121 = new ADTList<>();
        call121.add(new ArithExp('*', new VarExp("v"), new ValueExp(new IntValue(10))));
        call121.add(new VarExp("w"));
        IADTList<IExp> call122 = new ADTList<>();

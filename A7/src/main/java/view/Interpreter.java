...
public class Interpreter {
    public static void main(String[] args) {
        ...
        IADTStack<IStmt> exeStack9 = new ADTStack<IStmt>();
        exeStack9.push(ex9);
        IADTDictionary<String, IValue> symTable9 = new ADTDictionary<String, IValue>();
        IADTList<IValue> output9 = new ADTList<IValue>();
        IFileTable fileTable9 = new FileTable();
        IHeap heap9 = new Heap();
        IStmt originalPrg9 = ex9.deepCopy();
        try {
            IADTDictionary<String, IType> typeEnv9 = new ADTDictionary<String, IType>();
            ex9.typeCheck(typeEnv9);
            PrgState prg9 = new PrgState(exeStack9, symTable9, output9, fileTable9, heap9, originalPrg9);
        ...
        IADTStack<IStmt> exeStack10 = new ADTStack<IStmt>();
        exeStack10.push(ex10);
        IADTDictionary<String, IValue> symTable10 = new ADTDictionary<String, IValue>();
        IADTList<IValue> output10 = new ADTList<IValue>();
        IFileTable fileTable10 = new FileTable();
        IHeap heap10 = new Heap();
        IStmt originalPrg10 = ex10.deepCopy();
        try {
            IADTDictionary<String, IType> typeEnv10 = new ADTDictionary<String, IType>();
            ex10.typeCheck(typeEnv10);
            PrgState prg10 = new PrgState(exeStack10, symTable10, output10, fileTable10, heap10, originalPrg10);
